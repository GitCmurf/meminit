...
class WarningCode:
    ...
    W_GRAPH_DANGLING_RELATED_ID = "W_GRAPH_DANGLING_RELATED_ID"
    W_GRAPH_DANGLING_SUPERSEDED_BY = "W_GRAPH_DANGLING_SUPERSEDED_BY"
    W_GRAPH_SUPERSESSION_STATUS_MISMATCH = "W_GRAPH_SUPERSESSION_STATUS_MISMATCH"
