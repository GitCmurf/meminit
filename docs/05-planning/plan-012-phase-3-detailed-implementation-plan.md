...
1. Add a fixture loader helper under `tests/integration/test_protocol_*`
   that materializes scenarios into `tmp_path` from the fixture directory.
...
1. All 15 fixture scenarios are checked into the repo with README notes on
